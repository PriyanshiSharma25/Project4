...
public class UserListCtl extends BaseCtl {
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		...
		System.out.println("firstName=" + bean.getFirstName() + "" + "roleid=" + bean.getRoleId() + "" + "loginid="
				+ bean.getLogIn());
...
//	        get the selected checkbox ids array for delete list
		...
		try {
			...
			// first time list load hoti he uske bad NEXT button ko inadel karne ke
			// liye.NextList size chack kra
